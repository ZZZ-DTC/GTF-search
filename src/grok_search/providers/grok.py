            ...
            if line.startswith("data:"):
                ...
                try:
                    ...
                    if event_type == "response.output_text.delta":
                        ...
                        continue
                    if "output_text" in event_type and "delta" in data:
                        content += data.get("delta", "") or ""
                        continue
                    if event_type == "response.completed" and not content:
                        response_obj = data.get("response", {}) or {}
                        content += self._extract_responses_text(response_obj)
                        continue
        ...
        if not content and full_body_buffer:
            try:
                ...
                if "output_text" in data:
                    ...
                    content = self._extract_responses_text(data.get("response", {}) or {})
